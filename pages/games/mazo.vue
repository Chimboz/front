<template>
  <Container>
    ...
    <Card header="mazo.webp" left bg="mazo.gif">
      ...
      <NuxtLink to="/games/bacteria">
        Bacteria
      </NuxtLink> ou
      <NuxtLink to="/games/patojdur">
        Patojdur
      </NuxtLink> qui demandent des
    ...
    <Card id="tutorial" left>
      ...
      <template #subtitle>
        Attention : les visiteurs ne peuvent pas jouer !
      </template>
    ...
    <template #right-column>
      ...
      >
        ...
        <img
          ...
          @contextmenu.prevent
        >
        Le classement est mis à jour toutes les <b>10 minutes.</b><br>
      </Card>
    </template>
  </Container>
</template>
